...
def seed_documents(retrieved_at: str) -> list[DocumentCard]:
    ...
    return [
        ...
        doc("ndma_dos_donts", "sachet", "https://sachet.ndma.gov.in/DosDont", "SACHET Dos and Don'ts", "National Disaster Management Authority, India", "india", ["flood", "cyclone", "landslide", "heatwave", "lightning", "fire"], policy=india_retrieval, staleness_class="seasonal"),
